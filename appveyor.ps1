...
$vt = @{
   ...
   "LogMagic.Microsoft.Azure.ServiceFabric.csproj" = "5.7.$bn";
}
...
Get-ChildItem *.csproj -Recurse | Where-Object {-not($_.Name -like "*test*") -and -not($_.Name -like "*console*") -and -not($_.Name -like "*FabricApp*")} | % {
