...
namespace LogMagic.FabricApp.ActorSimulator
{
   ...
   internal class ActorSimulator : Actor, IActorSimulator
   {
      /// <summary>
      /// Initializes a new instance of ActorSimulator
      /// </summary>
      /// <param name="actorService">The Microsoft.ServiceFabric.Actors.Runtime.ActorService that will host this actor instance.</param>
      /// <param name="actorId">The Microsoft.ServiceFabric.Actors.ActorId for this actor instance.</param>
      public ActorSimulator(ActorService actorService, ActorId actorId)
      ...
      /// </summary>
      /// <returns></returns>
      Task<int> IActorSimulator.GetCountAsync(CancellationToken cancellationToken)
      {
